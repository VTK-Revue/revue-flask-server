...
class YearGroupYearPage(Page):
    ...
    __table_args__ = (db.PrimaryKeyConstraint('year_group_id', 'year_id'), {"schema": "content"})

    year_group_id = db.Column("year_group_id", db.Integer, db.ForeignKey('general.year_group.id'),
                              nullable=False)
